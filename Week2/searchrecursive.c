...
int main()
{
    ...
    scanf("%d",&key);
     ...
     cpu_time_used1=(double)(end1-start1) / CLOCKS_PER_SEC;
        (result == -1) ? printf("Element is not present in array of %d numbers and the cpu time used is %d\n",n,cpu_time_used1):
          printf("Element is present at index %d in array of %d numbers and cpu time used is %d\n",result,n,cpu_time_used1);
         n=n+2000;
    }
        break;
    case 2 : 
